      ...
      products.length > 0 ? (
        ...
        <div className='w-full h-full bg-white px-4 col-span-4'>
          <div className='font-titleFont flex items-center justify-between border-b-[1px] border-b-gray-400 py-3'>
            ...
            <h4 className='text-xl font-normal'>subtitles</h4>
          </div>
          {/* -----------------------------products start here--------------------------- */}
          <div>
            {
                ...
                <div className='w-1/5'>
                  ...
                  <div className='w-3/5'>
                    ...
                    <div className='bg-[#F0F2F2] flex justify-center items-center gap-1 w-24
                     py-1 text-center drop-shdow-lg rounded-md'>
                      <p>Qty:</p>
                      <p 
          ...
          <div className='w-full py-2'>
            ...
            className='px-10  py-2 rounded-lg bg-red-500 text-white mt-2 
            hover:bg-red-700 active:bg-red-900 duration-300 text-lg  font-titleFont font-semibold tracking-wide'
            >Clear Cart</button>
          </div>
        </div>
        ...
        <div className='w-96 p-4 bg-white flex flex-col items-center rounded-lg shadow-lg'>
          <h1 className='font-titleFont text-xl font-bold '>Your cart Feels lonely.</h1>
          <p className='text-sm text-center'>Yours shopping cart lives to serve. Give it purpose-fill it with books,
             electronics, videos etc. nad make it happy
          </p>
          <Link to="/">
           <button
              className='mt-6 bg-yellow-400 rounded-md px-8 py-2 font-titleFont font-semibold text-lg
