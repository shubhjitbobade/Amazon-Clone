...
function FooterMiddle() {
  return (
    <div className='w-full bg-amazon_light text-white'>
      {/* ---------------------Top Start Here--------------------- */}
      <div className='w-full border-b-[1px] border-gray-500 py-10  px-10'>
        <div className='max-w-5xl mx-auto text-gray-300'>
          <div className='w-full grid gris-cils-1 md:grid-cols-2 lgl:grid-cols-4 gap-6 md:place-items-center md:items-start '>
              {
                middleList.map((item)=>(
                  <FooterMiddleList
                   key={item._id}
            ...
            <div className='flex gap-1 items-center justify-center border border-gray-500
              ...
              <img className='w-6' src={bdFlag} alt="IndiaFlag" />
              <p>India</p>
            </div>
            </div>
            {/* ---------------------Bottom End Here--------------------- */}
